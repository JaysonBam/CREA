  ...
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.bulkInsert("issue_reports", [
      ...
      },
      {
        ...
        description: "There is a broken bench by Lynnwood Park that needs repair.",
        category: "OTHER",
        status: "RESOLVED",
        votes_count: 0,
        user_id: users[1].id,
      ...
      },
      {
        ...
        description: "Light flickers intermittently, unsafe for pedestrians at night.",
        category: "STREETLIGHT_FAILURE",
        status: "IN_PROGRESS",
        votes_count: 1,
        user_id: users[0].id,
      ...
      },
      {
        ...
        description: "Several potholes forming a cluster near the main mall entrance.",
        category: "POTHOLE",
        status: "ACKNOWLEDGED",
        votes_count: 5,
        user_id: users[1].id,
      ...
      },
      {
        ...
        description: "Slow but persistent leak behind the public library building.",
        category: "WATER_LEAK",
        status: "IN_PROGRESS",
        votes_count: 0,
        user_id: users[0].id,
      ...
      },
      {
        ...
        description: "Traffic lights were cycling incorrectly; issue has been resolved.",
        category: "OTHER",
        status: "RESOLVED",
        votes_count: 0,
        user_id: users[1].id,
